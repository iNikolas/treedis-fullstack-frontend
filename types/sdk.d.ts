...
export interface Camera {
   ...
   */
  rotateBetweenOrientations(
    startOrientation: Quaternion,
    endOrientation: Quaternion,
    duration: number,
    fadeToBlack: boolean,
    allowOverlappingTransitions: boolean
  ): Promise<void>;
  /**
   * @hidden
   * @internal
...
export declare namespace Graph {
  ...
  interface IDirectedGraph<T> {
     ...
     */
    addVertex(
      ...vertexData: T extends undefined | void
        ? VertexIdDescriptor[]
        : Array<VertexDescriptor<T>>
    ): void;
    /**
  ...
  interface IAStarRunner<T> {
    ...
    subscribe(
      observer:
        | IObserver<Graph.IAStarRunner<T>>
        | ObserverCallback<Graph.IAStarRunner<T>>
    ): ISubscription;
    /**
...
export declare namespace Sensor {
   ...
   */
  interface ISource<
    VolumeT = SphereVolume | BoxVolume | CylinderVolume,
...
export interface Sensor {
  ...
  ): Promise<Sensor.ISource<Sensor.SphereVolume, UserData>>;
  /**
  ...
  ): Promise<Sensor.ISource<Sensor.BoxVolume, UserData>>;
  /**
  ...
  ): Promise<Sensor.ISource<Sensor.CylinderVolume, UserData>>;
}
...
export interface Tag {
  ...
  importTags(
    spaceSid: string,
    options: Partial<Tag.ImportTagsOptions>
  ): Promise<string[]>;
  /**
  ...
  editStem(
    tagSid: string,
    options: Partial<Tag.StemHeightEditOptions>
  ): Promise<void>;
  /**
...
export interface View {
  ModelViewType: typeof View.ModelViewType;
  /**
   ...
   * @internal
   *
   * Toggle between the base view and the first defurnish view
   */
  toggleDefurnish(): Promise<void>;
}
interface Emitter {
